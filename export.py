...
def run(
        ...
        weights=ROOT / 'runs/train/exp10/weights/best.pt',  # weights path
        imgsz=(640, 640),  # image (height, width)
        batch_size=1,  # batch size
        device='0',  # cuda device, i.e. 0 or 0,1,2,3 or cpu
        include=('engine'),  # include formats 'torchscript', 'onnx',
...
def parse_opt(known=False):
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[228, 228], help='image (h, w)')#[640,640]
    parser.add_argument('--batch-size', type=int, default=1, help='batch size')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--half', default = 'True', help='FP16 half-precision export')#store_true action='store_true'
